...
public class wall_sit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wall_sit);

        videoView = findViewById(R.id.wall_sit_video);
        ...
        btnStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.wall_sit;
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                timer.stop();
                timer.setBase(SystemClock.elapsedRealtime());
                Intent intent = new Intent(wall_sit.this,MainMenu.class);
