...
public class jumping_jack extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jumping_jack);

        videoView = findViewById(R.id.jump_jack_video);
        ...
        btnStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.jumping_jack;
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                timer.stop();
                timer.setBase(SystemClock.elapsedRealtime());
                Intent intent = new Intent(jumping_jack.this,cardio.class);
