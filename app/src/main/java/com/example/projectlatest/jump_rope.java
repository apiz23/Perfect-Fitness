...
public class jump_rope extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoView = findViewById(R.id.jump_rope_video);
        ...
        btnStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.skipping;
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                timer.stop();
                timer.setBase(SystemClock.elapsedRealtime());
                Intent intent = new Intent(jump_rope.this,cardio.class);
