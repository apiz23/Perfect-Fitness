    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nav.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.home:
                        intent1 = new Intent(butt.this, MainMenu.class);
                        startActivity(intent1);
                        break;
                    case R.id.info:
                        intent2 = new Intent(butt.this, info.class);
        ...
        startAct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(butt.this,squats.class);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(butt.this,challenges.class);
                startActivity(intent);
            }
        });
    }
