...
public class triceps_dips extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.triceps_dips);

        videoView = findViewById(R.id.triceps_dips_video);
        ...
        btnStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.triceps_dips;
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                timer.stop();
                timer.setBase(SystemClock.elapsedRealtime());
                Intent intent = new Intent(triceps_dips.this,plank.class);
