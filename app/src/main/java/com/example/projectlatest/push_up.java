...
public class push_up extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoView = findViewById(R.id.push_up_video);
        ...
        btnStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.push_up;
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                timer.stop();
                timer.setBase(SystemClock.elapsedRealtime());
                Intent intent = new Intent(push_up.this,triceps_dips.class);
