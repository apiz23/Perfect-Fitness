...
public class abdominal_crunches extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.abdominal_crunches);

        videoView = findViewById(R.id.abdominal_crunches_video);
        ...
        btnStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.abdominal_crunches;
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(abdominal_crunches.this,sit_up.class);
